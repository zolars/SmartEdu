...
var PNotify = (function() {
  ...
  var insertStackOverlay = function insertStackOverlay(stack) {
    if (stack.overlay.parentNode !== stack.context) {
      stack.overlay = stack.context.insertBefore(
        stack.overlay,
        stack.context.firstChild
      );
    }
  };
  ...
  function _styles(_ref) {
    ...
    return (typeof styling === "undefined" ? "undefined" : _typeof(styling)) ===
      "object"
      ? styling
      : PNotify.styling[styling];
  }

  function _icons(_ref2) {
    var icons = _ref2.icons;

    return (typeof icons === "undefined" ? "undefined" : _typeof(icons)) ===
      "object"
      ? icons
      : PNotify.icons[icons];
  }
  ...
  var methods = {
    ...
    open: function open() {
      ...
      if (
        ...
        (stack && stack.context && stack.context !== this.refs.elem.parentNode)
      ) {
    ...
    animateOut: function animateOut(callback) {
      ...
      var finished = function finished() {
        ...
        if (
          !_this4.refs.elem.style.opacity ||
          _this4.refs.elem.style.opacity === "0" ||
          !visible
        ) {
    ...
    position: function position() {
      ...
      if (stack.dir1 && stack.dir2) {
        ...
        var endY =
          stack.nextpos1 +
          elem.offsetHeight +
          (typeof stack.spacing1 === "undefined" ? 25 : stack.spacing1);
        var endX =
          stack.nextpos1 +
          elem.offsetWidth +
          (typeof stack.spacing1 === "undefined" ? 25 : stack.spacing1);
        if (
          ...
          stack.nextpos2 +=
            stack.addpos2 +
            (typeof stack.spacing2 === "undefined" ? 25 : stack.spacing2);
          stack.addpos2 = 0;
        }
    ...
    removeModuleClass: function removeModuleClass() {
      ...
      for (
        var _len2 = arguments.length, classNames = Array(_len2), _key2 = 0;
        _key2 < _len2;
        _key2++
      ) {
    ...
    hasModuleClass: function hasModuleClass() {
      ...
      for (
        var _len3 = arguments.length, classNames = Array(_len3), _key3 = 0;
        _key3 < _len3;
        _key3++
      ) {
  ...
  function oncreate() {
    ...
    this.on("mouseleave", function(e) {
      ...
      if (
        _this6.get().hide &&
        _this6.get().mouseReset &&
        _this6.get()._animating !== "out"
      ) {
        _this6.queueClose();
      }
      PNotify.positionAll();
  ...
  function create_main_fragment(component, ctx) {
    ...
    for (var i = 0; i < each0_value.length; i += 1) {
      ...
      each0_blocks_1[i] = each0_lookup[key] = create_each_block_1(
        component,
        key,
        child_ctx
      );
    ...
    for (var i = 0; i < each1_value.length; i += 1) {
      ...
      each1_blocks_1[i] = each1_lookup[_key4] = create_each_block(
        component,
        _key4,
        _child_ctx
      );
    ...
    return {
      c: function c() {
        ...
        div0.style.cssText = div0_style_value =
          "" + ctx._widthStyle + " " + ctx._minHeightStyle;
        ...
        div1.className = div1_class_value =
          ...
          "\n      " +
          (ctx.animation === "fade"
            ? "ui-pnotify-fade-" + ctx.animateSpeed
            : "") +
          "\n      " +
      ...
      p: function p(changed, ctx) {
        var each0_value = ctx._modulesPrependContainer;
        each0_blocks_1 = updateKeyedEach(
          each0_blocks_1,
          component,
          changed,
          get_key,
        ...
        if (
          (changed._widthStyle || changed._minHeightStyle) &&
          div0_style_value !==
            (div0_style_value =
              "" + ctx._widthStyle + " " + ctx._minHeightStyle)
        ) {
        ...
        if (
          (changed.icon ||
            changed._styles ||
            changed.addClass ||
            changed._animatingClass ||
            changed._moveClass ||
            changed.animation ||
            changed.animateSpeed ||
            changed.stack ||
            changed._moduleClasses) &&
          div1_class_value !==
            (div1_class_value =
              "\n      ui-pnotify\n      " +
              (ctx.icon !== false ? "ui-pnotify-with-icon" : "") +
    ...
    return {
      c: function c() {
        ...
        div.className = div_class_value =
          "ui-pnotify-icon " + (ctx._styles.icon ? ctx._styles.icon : "");
      },
      m: function m(target, anchor) {
      ...
      p: function p(changed, ctx) {
        if (
          (changed.icon || changed._icons || changed.type) &&
          span_class_value !==
            (span_class_value =
              ctx.icon === true
                ? ctx._icons[ctx.type]
      ...
      d: function d(detach) {
        ...
        if (component.refs.iconContainer === div)
          component.refs.iconContainer = null;
      }
    };
  }
    ...
    return {
      c: function c() {
        ...
        h4.className = h4_class_value =
          "ui-pnotify-title " + (ctx._styles.title ? ctx._styles.title : "");
      },
      m: function m(target, anchor) {
      ...
      p: function p(changed, ctx) {
        ...
        if (
          ...
          h4_class_value !==
            (h4_class_value =
              "ui-pnotify-title " +
              (ctx._styles.title ? ctx._styles.title : ""))
        ) {
          h4.className = h4_class_value;
        }
      },
      d: function d(detach) {
        ...
        if_block.d();
        if (component.refs.titleContainer === h4)
          component.refs.titleContainer = null;
      }
    };
  }
  ...
  function create_if_block(component, ctx) {
    ...
    return {
      c: function c() {
        ...
        if_block.c();
        div.className = div_class_value =
          "ui-pnotify-text " + (ctx._styles.text ? ctx._styles.text : "");
      ...
      d: function d(detach) {
        ...
        if_block.d();
        if (component.refs.textContainer === div)
          component.refs.textContainer = null;
      }
    };
  }
  ...
  PNotify_1.prototype._recompute = function _recompute(changed, state) {
    if (changed.styling) {
      if (this._differs(state._styles, (state._styles = _styles(state))))
        changed._styles = true;
    }

    if (changed.icons) {
      if (this._differs(state._icons, (state._icons = _icons(state))))
        changed._icons = true;
    }
    ...
    if (changed.width) {
      if (
        this._differs(
          state._widthStyle,
          (state._widthStyle = _widthStyle(state))
        )
      )
        changed._widthStyle = true;
    }

    if (changed.minHeight) {
      if (
        this._differs(
          state._minHeightStyle,
          (state._minHeightStyle = _minHeightStyle(state))
        )
      )
        changed._minHeightStyle = true;
    }
  };
