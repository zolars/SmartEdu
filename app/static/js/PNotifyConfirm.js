...
var PNotifyConfirm = (function(PNotify) {
  ...
  var methods = {
    ...
    handleClick: function handleClick(button, event) {
      if (button.click) {
        button.click(
          this.get()._notice,
          this.get().prompt ? this.get().promptValue : null,
          event
        );
      }
    },
  ...
  function create_main_fragment(component, ctx) {
    ...
    var if_block =
      (ctx.confirm || ctx.prompt) && create_if_block(component, ctx);
    ...
    return {
      c: function c() {
        ...
        div0.className = div0_class_value =
          ...
          (ctx._notice.get()._styles.actionBar
            ? ctx._notice.get()._styles.actionBar
            : "") +
          "\n          " +
          (ctx._notice.get()._styles.text
            ? ctx._notice.get()._styles.text
            : "") +
          "\n        " +
          " svelte-1y9suua";
    ...
    return {
      c: function c() {
        ...
        div.className = div_class_value =
          ...
          (ctx._notice.get()._styles.promptBar
            ? ctx._notice.get()._styles.promptBar
            : "") +
          "\n            " +
          (ctx._notice.get()._styles.text
  ...
  function create_else_block_1(component, ctx) {
    ...
    return {
      ...
      p: function p(changed, ctx) {
        if (!input_updating && changed.promptValue)
          input.value = ctx.promptValue;
        if (
          (changed._notice || changed.promptClass) &&
          input_class_value !==
            (input_class_value =
              "\n                ui-pnotify-prompt-input\n                " +
              (ctx._notice.get()._styles.input
      ...
      d: function d(detach) {
        ...
        if (component.refs.promptSingle === input)
          component.refs.promptSingle = null;
      }
    };
  }
  ...
  function create_if_block_3(component, ctx) {
    ...
    return {
      ...
      p: function p(changed, ctx) {
        if (!textarea_updating && changed.promptValue)
          textarea.value = ctx.promptValue;
        if (
          (changed._notice || changed.promptClass) &&
          textarea_class_value !==
      ...
      d: function d(detach) {
        ...
        if (component.refs.promptMulti === textarea)
          component.refs.promptMulti = null;
      }
    };
  }
    ...
    return {
      c: function c() {
        ...
        button.className = button_class_value =
          ...
          (ctx.button.primary
            ? ctx._notice.get()._styles.btnPrimary
              ? ctx._notice.get()._styles.btnPrimary
              : ""
            : ctx._notice.get()._styles.btn
            ? ctx._notice.get()._styles.btn
            : "") +
          "\n              " +
      ...
      p: function p(changed, _ctx) {
        ...
        if (
          (changed.buttons || changed._notice) &&
          button_class_value !==
            (button_class_value =
              "\n              ui-pnotify-action-button\n              " +
              (ctx.button.primary
